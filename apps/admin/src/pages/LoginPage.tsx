          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-green-500 pe-9"
                placeholder="••••••••"
                required
              />
              <button
                ...
                className="absolute inset-y-0 end-0 flex items-center px-2.5 text-gray-400 hover:text-gray-600"
                tabIndex={-1}
              >
                {showPassword ? (
