export function EmptyMapOverlay() {
  return (
    <div className="absolute inset-0 z-10 pointer-events-none">
      ...
      <div className="md:hidden flex flex-col items-center absolute inset-0 justify-center">
        ...
        <svg
          ...
          style={{ filter: "drop-shadow(0 4px 12px rgba(34,197,94,0.4))" }}
        >
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={3} d="M12 4v12m0 0l-5-5m5 5l5-5" />
        </svg>
      </div>
